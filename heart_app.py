...
@st.cache_resource
def load_model():st.set_page_config(page_title= "Heart Disease Prediction", layout="wide")
...
.disease f background-color: #ffebee; color: #c62828;
.healthy f background-color: #e8f5e9; color: #2e7d32;
  try:
...
if model is not None:
    ...
    # Placeholder for prediction and proba, assuming they will be calculated
    prediction = 0 # Replace with actual prediction logic
    proba = [0.6, 0.4] # Replace with actual probability logic
    input_data = {} # Replace with actual input data summary
    ...
    if prediction==1:
         st.error("**High Risk Detected:**Consult a cardiologist immediately.maintain healthy lifestyle,monitor vitals,and seek medical attention.")
    else:
